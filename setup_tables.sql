...
CREATE TABLE UtilizadaEm(
    ...
    QuantidadeDisponível NUMBER(10) CHECK(Numero >= 0) NOT NULL,
...
CREATE TABLE IngressoCompra(
    ...
    CONSTRAINT FK_INGRESSOCOMPRA_ID FOREIGN KEY (IDIngresso)
        REFERENCES  IngressoDaAtracao(IDIngresso)
        ON DELETE CASCADE,
...
CREATE TABLE Jogo(
    ...
    CONSTRAINT FK_JOGO_EQ1 FOREIGN KEY (Equipe)
        REFERENCES Equipe(Equipe)
        ON DELETE CASCADE,
    CONSTRAINT FK_JOGO_EQ2 FOREIGN KEY (Equipe)
        REFERENCES Equipe(Equipe)
        ON DELETE CASCADE,
...
CREATE TABLE ParticipacaoUniversidade(
    Universidade VARCHAR2(100) NOT NULL,
    Evento NUMBER(10) NOT NULL,
    MOuro NUMBER(3) CHECK(Numero >= 0) NOT NULL,
    MPrata NUMBER(3) CHECK(Numero >= 0) NOT NULL,
    MBronze NUMBER(3) CHECK(Numero >= 0) NOT NULL,
